...
// Get current user
    $http.get("http://localhost:9090/api/users/"+$scope.loggedInUser).success(function(response){
        ...
        //Get events
        $http.get('http://localhost:9090/api/events/'+$scope.loggedInUser).success(function(response){
        ...
        //Get time
        $http.get('http://localhost:9090/api/time/'+$scope.loggedInUser).success(function(response){
